...
from code2test.src.be.dependency_analyzer.models.core import Node, CallRelationship
from code2test.src.be.dependency_analyzer.utils.patterns import CODE_EXTENSIONS
from code2test.src.be.dependency_analyzer.utils.security import safe_open_text
...
class CallGraphAnalyzer:
    ...
    def _analyze_python_file(self, file_path: str, content: str, base_dir: str):
        ...
        """
        from code2test.src.be.dependency_analyzer.analyzers.python import analyze_python_file
    ...
    def _analyze_javascript_file(self, file_path: str, content: str, repo_dir: str):
        ...
        try:
            ...
            from code2test.src.be.dependency_analyzer.analyzers.javascript import analyze_javascript_file_treesitter
    ...
    def _analyze_typescript_file(self, file_path: str, content: str, repo_dir: str):
        ...
        try:
            ...
            from code2test.src.be.dependency_analyzer.analyzers.typescript import analyze_typescript_file_treesitter
    ...
    def _analyze_c_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            repo_dir: Repository base directory
        """
        from code2test.src.be.dependency_analyzer.analyzers.c import analyze_c_file
    ...
    def _analyze_cpp_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            content: File content string
        """
        from code2test.src.be.dependency_analyzer.analyzers.cpp import analyze_cpp_file
    ...
    def _analyze_java_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            repo_dir: Repository base directory
        """
        from code2test.src.be.dependency_analyzer.analyzers.java import analyze_java_file
    ...
    def _analyze_csharp_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            repo_dir: Repository base directory
        """
        from code2test.src.be.dependency_analyzer.analyzers.csharp import analyze_csharp_file
    ...
    def _analyze_php_file(self, file_path: str, content: str, repo_dir: str):
        ...
        Args:
            ...
            repo_dir: Repository base directory
        """
        from code2test.src.be.dependency_analyzer.analyzers.php import analyze_php_file
