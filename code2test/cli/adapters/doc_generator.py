...
from code2test.cli.utils.progress import ProgressTracker
from code2test.cli.models.job import DocumentationJob, LLMConfig
from code2test.cli.utils.errors import APIError

# Import backend modules
from code2test.src.be.documentation_generator import DocumentationGenerator
from code2test.src.config import Config as BackendConfig, set_cli_context
...
class CLIDocumentationGenerator:
    ...
    def _configure_backend_logging(self):
        ...
        from code2test.src.be.dependency_analyzer.utils.logging_config import ColoredFormatter
    ...
    async def _run_backend_generation(self, backend_config: BackendConfig):
        ...
        from code2test.src.be.cluster_modules import cluster_modules
        from code2test.src.utils import file_manager
        from code2test.src.config import FIRST_MODULE_TREE_FILENAME, MODULE_TREE_FILENAME
    ...
    def _run_html_generation(self):
        ...
        from code2test.cli.html_generator import HTMLGenerator
