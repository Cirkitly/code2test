...
from code2test.cli.utils.errors import (
    ConfigurationError,
    RepositoryError,
    APIError,
    handle_error,
...
from code2test.cli.utils.repo_validator import (
    validate_repository,
...
from code2test.cli.utils.logging import create_logger
from code2test.cli.adapters.doc_generator import CLIDocumentationGenerator
from code2test.cli.utils.instructions import display_post_generation_instructions
from code2test.cli.models.job import GenerationOptions
from code2test.cli.models.config import AgentInstructions
...
def generate_command(
    ...
    try:
        ...
        if create_branch:
            ...
            from code2test.cli.git_manager import GitManager
